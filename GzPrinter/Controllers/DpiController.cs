...
{
    internal class DpiController : IController
    {
        ...
        public void ProcessRequest(MyHttpServer httpServer, Dictionary<string, string> data, HttpListenerResponse resp, string route = "", string request_type = "get")
        {
            ...
            var ret=new PrintHelper().GetDpi(printerName);
            var rsp = Newtonsoft.Json.JsonConvert.SerializeObject(new { x = ret.Item1, y = ret.Item2 });
